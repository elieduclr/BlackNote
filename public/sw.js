// BlackNote.js Service Worker v2.0.5
// Ultra-secure offline-first note manager

const CACHE_NAME = 'blacknote-v2.0.5';
const STATIC_CACHE = 'blacknote-static-v2.0.5';
const DYNAMIC_CACHE = 'blacknote-dynamic-v2.0.5';
...
self.addEventListener('install', (event) => {
  console.log('[SW] Installing BlackNote.js Service Worker v2.0.5');
...
self.addEventListener('activate', (event) => {
  console.log('[SW] Activating BlackNote.js Service Worker v2.0.5');
...
self.addEventListener('message', (event) => {
  ...
  if (event.data && event.data.type === 'GET_VERSION') {
    event.ports[0].postMessage({ version: '2.0.5' });
  }
...
console.log('[SW] BlackNote.js Service Worker v2.0.5 loaded');