// BlackNote.js Service Worker v2.0.3
// Ultra-secure offline-first note manager

const CACHE_NAME = 'blacknote-v2.0.3';
const STATIC_CACHE = 'blacknote-static-v2.0.3';
const DYNAMIC_CACHE = 'blacknote-dynamic-v2.0.3';
...
self.addEventListener('install', (event) => {
  console.log('[SW] Installing BlackNote.js Service Worker v2.0.3');
...
self.addEventListener('activate', (event) => {
  console.log('[SW] Activating BlackNote.js Service Worker v2.0.3');
...
self.addEventListener('message', (event) => {
  ...
  if (event.data && event.data.type === 'GET_VERSION') {
    event.ports[0].postMessage({ version: '2.0.3' });
  }
...
console.log('[SW] BlackNote.js Service Worker v2.0.3 loaded');