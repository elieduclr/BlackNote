  ...
  return (
    <div className="relative">
      <button
        ...
        className="w-full flex items-center justify-between px-3 sm:px-4 py-2.5 sm:py-3 bg-slate-800/50 border border-slate-700/50 rounded-lg sm:rounded-xl text-white hover:bg-slate-800/70 transition-all duration-200 backdrop-blur-sm"
      >
        <div className="flex items-center space-x-2 min-w-0">
          <Tags className="w-4 h-4 sm:w-5 sm:h-5 text-slate-400 flex-shrink-0" />
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-slate-800/95 backdrop-blur-xl border border-slate-700/50 rounded-lg sm:rounded-xl shadow-xl z-50 max-h-64 overflow-y-auto">
          {selectedTags.length > 0 && (
